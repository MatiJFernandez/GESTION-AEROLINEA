"""
Repositorios para la aplicación reservas.
...
class ReservaRepository:
    ...
    def crear(self, datos_reserva):
        ...
        """
        return Reserva.objects.create(**datos_reserva)
    ...
    def obtener_con_detalles(self, reserva_id):
        """
    ...
    def obtener_por_usuario(self, usuario_id):
        ...
        Returns:
            QuerySet: Reservas del usuario
        """
        return Reserva.objects.filter(usuario_id=usuario_id).select_related(
            'pasajero', 'vuelo', 'asiento'
        ).order_by('-fecha_creacion')
    
    def obtener_por_pasajero(self, pasajero_id):
        """
        ...
        Returns:
            QuerySet: Reservas del pasajero
        """
        return Reserva.objects.filter(pasajero_id=pasajero_id).select_related(
            'vuelo', 'asiento', 'usuario'
        ).order_by('-fecha_creacion')
    
    def obtener_por_vuelo(self, vuelo_id):
        """
        ...
        Returns:
            QuerySet: Reservas del vuelo
        """
        return Reserva.objects.filter(vuelo_id=vuelo_id).select_related(
    ...
    def buscar_por_criterios(self, criterios):
        ...
        Returns:
            QuerySet: Reservas que cumplen los criterios
        """
    ...
    def obtener_reservas_activas(self):
        ...
        """
        return Reserva.objects.filter(estado='confirmada').select_related(
            'pasajero', 'vuelo', 'asiento', 'usuario'
        ).order_by('-fecha_creacion')
    
    def obtener_reservas_expiradas(self):
        """
        Obtiene las reservas expiradas.
        
        Returns:
            QuerySet: Reservas expiradas
        """
    ...
    def actualizar(self, reserva_id, datos_actualizacion):
        """
        ...
        Returns:
            Reserva: Reserva actualizada o None
        """
        try:
    ...
    def contar_por_estado(self):
        ...
        """
        return Reserva.objects.values('estado').annotate(
    ...
    def obtener_estadisticas(self):
        ...
        return {
            ...
            'expiradas': self.obtener_reservas_expiradas().count(),
        } 